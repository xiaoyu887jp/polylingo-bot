        ...
        if event["type"] == "message" and event["message"]["type"] == "text":
            ...
            if group_id == TARGET_GROUP_ID:
                reply_to_line(reply_token, [
                    {"type": "text", "text": f"用户的个人ID为：{user_id}"}
                ])
