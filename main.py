...
flex_message_json = {
    ...
    "header": {
        ...
        "backgroundColor": "#FFCC80"  # 柔和的浅黄色标题背景
    },
    "body": {
        "type": "box",
        "layout": "vertical",
        ...
        "contents": [
            ...
            {"type":"button","style":"primary","color":"#166534","action":{"type":"message","label":"🇨🇳 简体中文","text":"zh-cn"}},
            {"type":"button","style":"primary","color":"#2563EB","action":{"type":"message","label":"🇹🇼 繁體中文","text":"zh-tw"}},
            {"type":"button","style":"primary","color":"#B91C1C","action":{"type":"message","label":"🇯🇵 日本語","text":"ja"}},
            {"type":"button","style":"primary","color":"#7E22CE","action":{"type":"message","label":"🇰🇷 한국어","text":"ko"}},
            {"type":"button","style":"primary","color":"#D97706","action":{"type":"message","label":"🇹🇭 ภาษาไทย","text":"th"}},
            {"type":"button","style":"primary","color":"#F97316","action":{"type":"message","label":"🇻🇳 Tiếng Việt","text":"vi"}},
            {"type":"button","style":"primary","color":"#0E7490","action":{"type":"message","label":"🇫🇷 Français","text":"fr"}},
            ...
            {"type":"button","style":"primary","color":"#166534","action":{"type":"message","label":"🇮🇩 Bahasa Indonesia","text":"id"}},
            {"type":"button","style":"primary","color":"#B91C1C","action":{"type":"message","label":"🇮🇳 हिन्दी","text":"hi"}},
            {"type":"button","style":"primary","color":"#15803D","action":{"type":"message","label":"🇮🇹 Italiano","text":"it"}},
            {"type":"button","style":"primary","color":"#F97316","action":{"type":"message","label":"🇵🇹 Português","text":"pt"}},
            {"type":"button","style":"primary","color":"#7E22CE","action":{"type":"message","label":"🇷🇺 Русский","text":"ru"}},
            {"type":"button","style":"primary","color":"#B91C1C","action":{"type":"message","label":"🇸🇦 العربية","text":"ar"}},
